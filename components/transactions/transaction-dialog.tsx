...
export function AddTransactionFab({ className }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={cn(
        "fixed right-4 bottom-[calc(4.75rem+env(safe-area-inset-bottom))] z-40 flex size-13 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg transition-transform active:scale-95 lg:hidden",
