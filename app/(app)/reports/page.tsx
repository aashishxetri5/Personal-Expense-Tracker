...
import { CardSkeleton, StatsSkeleton, TableSkeleton } from "@/components/ui/skeletons";
...
export default async function ReportsPage({
  ...
  return (
    <div className="space-y-5">
      ...
      <Suspense key={JSON.stringify(params)} fallback={<ReportsSkeleton />}>
...
async function ReportsContent({ params }: { params: { m?: string; period?: string } }) {
  const month = parseMonthKey(params.m);
  const period: ReportPeriod =
    params.period === "quarter" || params.period === "year" ? params.period : "month";
...
function ReportsSkeleton() {
  return (
    <>
      <StatsSkeleton count={4} className="sm:grid-cols-2 xl:grid-cols-4" />
    <div className="grid gap-4 lg:grid-cols-2">
